...
import 'package:social_app/widgets/circle_animation.dart';

import 'package:social_app/widgets/videoplayeritem.dart';

class VidieoPage extends StatefulWidget {
  @override
  _VidieoPageState createState() => _VidieoPageState();
}

class _VidieoPageState extends State<VidieoPage> {
  String uId;
  Stream myStream;
  ...
  likeVideo(String id)async{
    ...
    DocumentSnapshot doc = await vidioesCollection.doc(id).get();
    if(doc.data()['likes'].contains(uId)){
      vidioesCollection.doc(id).update({
  ...
  void initState() {
    ...
    myStream = vidioesCollection.snapshots();
  }
  @override
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          InkWell(
                                            onTap: (){
                                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>CommentsPage(videos.data()['id'])
                                              ));
