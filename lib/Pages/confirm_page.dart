...
class _ConfirmPageState extends State<ConfirmPage> {
  ...
  uploadVideoToStorage(String id)async{
    StorageUploadTask storageUploadTask = vidioesFolder.child(id).putFile(await compressVideo());
