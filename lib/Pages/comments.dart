...
class _CommentsPageState extends State<CommentsPage> {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                  stream: vidioesCollection.doc(widget.id).collection('comments').snapshots(),
  ...
  publishComments()async{
    ...
    var allDocs = await vidioesCollection.doc(widget.id).collection('comments').get();
    int length = allDocs.docs.length;
    vidioesCollection.doc(widget.id).collection('comments').doc('Comment $length').set({
    ...
    DocumentSnapshot doc = await vidioesCollection.doc(widget.id).get();
    vidioesCollection.doc(widget.id).update({
  ...
  likeComment(String id)async{
    ...
    await vidioesCollection.doc(widget.id).collection('comments').doc(id).get();
    if(doc.data()['likes'].contains(uId)){
      vidioesCollection.doc(widget.id).collection('comments').doc(id).update({
